 ...
 * @author PEMPEC
 */
public class CadastroTituloReceberBaixaLoteFPInternet extends FinanceInternalFrame implements IRepopuladorNew {
    ...
    public CadastroTituloReceberBaixaLoteFPInternet(CadastroTituloReceberBaixaLote baixa, TituloReceberBaixaFormaPagamentoModel formaPagamento, SacadoModel sacadoModel) throws SystemException {
        ...
        if (sacadoModel != null && sacadoModel.getPk() !=null) {
            ...
            sacado.setBanco(sacadoModel.getBanco());
        }
