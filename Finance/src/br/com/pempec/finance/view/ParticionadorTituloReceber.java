 ...
 * @author PEMPEC
 */
public class ParticionadorTituloReceber extends FinanceInternalFrame implements IRepopulador {

    private TituloReceberBO tituloReceberBO = new TituloReceberBO();
    private long tela = Tela.TELA_CONTAS_A_RECEBER_PARTICIONAMENTO.getTela();

    private String NameObject() {
        return (String) "Particionar Título a Receber";
    }

    public ParticionadorTituloReceber() throws SystemException {
    ...
    public void repopularCombos() {
        ...
        try {
            ...
            Collection<TituloReceberModel> lColecao = tituloReceberBO.obterTodosAReceber(organizacaoModel);
    ...
    private void initComponents() {
        ...
        setTitle("PEMPEC ENTERPRISE - Finance - PARTICIONAMENTO DE TÍTULO A RECEBER");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 204, 0)), NameObject()));
        ...
        labelValorPagar.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Valor a Receber"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 204, 153), 2), "Dados do Novo Título"));
        ...
        labelDataEmissao1.setText("Valor a Receber");

        labelDataEmissao2.setText("Data Vencimento");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(labelSacado, javax.swing.GroupLayout.PREFERRED_SIZE, 370, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addComponent(labelObservacao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 414, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void botaoParticionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoParticionarActionPerformed
        ...
        try {
            ...
            if (validaCampos()) {
                ...
                ParticionadorTituloReceberModel particionadorTituloReceber = new ParticionadorTituloReceberModel();

                particionadorTituloReceber.setUsuario(Controller.getUsuarioLogado());
                ...
                if (tab.getLoteContabil() == null) {
                    ...
                    try {
                        ...
                        clone = (TituloReceberModel) BeanUtils.cloneBean(tab);
                    ...
                    clone.setObservacao("Título Desmembrado de :" + tab.getNumeroDocumento());
                    ...
                    TituloReceberModel tituloDuplicidade = tituloReceberBO.consultarPorTemplate(clone);
                    ...
                    clone.setUsuario(particionadorTituloReceber.getUsuario());

                    clone.setMovimentoDiarioModel(registroMovimento("Particionar TR", tab.getNumeroDocumento(), "Título Particionado : " + tab.getNumeroDocumento(), clone.getValorNominal(), "Particionado"));
                    ...
                    if (tituloReceberBO.consultarPorTemplateAReceber(clone) != null) {
                        String novoNumero = PempecKeyGenerator.generateNumeroDocumentoTituloReceber();
                        clone.setNumeroDocumento(novoNumero);

                    }
                    particionadorTituloReceber.setTituloNovo(clone);
                    particionadorTituloReceber.setTituloAnterior(tab);

                    tituloReceberBO.particionar(particionadorTituloReceber);
