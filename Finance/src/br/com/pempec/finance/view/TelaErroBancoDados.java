 ...
 * @author PEMPEC
 */
public class TelaErroBancoDados extends FinanceInternalFrame implements IRepopulador {
    ...
    public TelaErroBancoDados(File screen) {
    ...
    private void initComponents() {
        ...
        setTitle("PEMPEC ENTERPRISE - Finance - Erro no Banco de Dados.");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 0, 0));
        jLabel1.setText("ERRO DE BANCO DE DADOS");
        ...
        labelTela.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        labelTela.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));

        labelMensagem.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(labelDataHora, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
