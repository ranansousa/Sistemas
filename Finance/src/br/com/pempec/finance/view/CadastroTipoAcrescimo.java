...
import br.com.pempec.finance.utils.iterators.TipoAcrescimoTextFilterator;
 ...
 * @author PEMPEC
 */
public class CadastroTipoAcrescimo extends FinanceInternalFrame implements IRepopulador {

    private TipoAcrescimoBO tipoAcrescimoBO = new TipoAcrescimoBO();
    private HistoricoBO historicoBO = new HistoricoBO();
    private long tela = Tela.TELA_PARAMETROS_TIPOS_DE_ACRESCIMOS.getTela();

    public CadastroTipoAcrescimo() throws SystemException {
    ...
    private void initComponents() {
        ...
        comboTipoAcrescimo = new javax.swing.JComboBox();
        ...
        comboTipoAcrescimo.setFont(getFont());
        comboTipoAcrescimo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboTipoAcrescimoActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(comboTipoAcrescimo, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(comboTipoAcrescimo, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
    ...
    public void repopularCombos() {
        ...
        try {
            ...
            Collection<TipoAcrescimoModel> lColecao = tipoAcrescimoBO.obterTodos(organizacaoModel);
            ...
            final EventList<TipoAcrescimoModel> lRegistros = GlazedLists.eventList(lColecao);
            if (support != null && support.getItemList() != null && support.getComboBox() != null) {
                support.uninstall();
            }
            support = AutoCompleteSupport.install(comboTipoAcrescimo, lRegistros, new TipoAcrescimoTextFilterator());
    ...
    private void comboTipoAcrescimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboTipoAcrescimoActionPerformed
        ...
        if (comboTipoAcrescimo.getSelectedItem() != null && (userEnteredTextAndPressedReturn || userSelectedTextFromList)) {


            try {

                TipoAcrescimoModel tab = new TipoAcrescimoModel();
                tab.setDescricao(comboTipoAcrescimo.getSelectedItem().toString());
                tab.setPk(new PKModel());
                tab.getPk().setOrganizacao(Controller.getOrganizacao());
                tab = tipoAcrescimoBO.consultarPorTemplate(tab);
...
}//GEN-LAST:event_comboTipoAcrescimoActionPerformed
    ...
    private void botaoLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoLimparActionPerformed
        ...
        campoCodigo.setText("");
        comboTipoAcrescimo.setSelectedItem(null);
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        if (comboTipoAcrescimo.getSelectedItem() != null) {
            valorCombo = comboTipoAcrescimo.getSelectedItem().toString();
        }
        ...
        if (valorCombo != null) {
            ...
            try {
                ...
                tab.setMovimentoDiarioModel(registroMovimento("Deletar Tipo Acrescimo", valorCombo, tab.getDescricao(), null, "Deletado"));

                tipoAcrescimoBO.excluir(tab);
    ...
    private Boolean validaCampos() {
        ...
        if (comboTipoAcrescimo.getSelectedItem() == null) {
            comboTipoAcrescimo.requestFocus();
            return false;
        }
    ...
    private void botaoIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoIncluirActionPerformed
        ...
        if (comboTipoAcrescimo.getSelectedItem() != null) {
            valorCombo = comboTipoAcrescimo.getSelectedItem().toString().toUpperCase();
        }
        ...
        if (valorCombo != null) {
            ...
            try {
                ...
                if (validaCampos()) {
                    ...
                    tab.setMovimentoDiarioModel(registroMovimento("Insere Tipo Acrescimo", valorCombo, tab.getDescricao(), null, "Inserido"));
                    tipoAcrescimoBO.inserir(tab);
...
private void botaoAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAlterarActionPerformed
    ...
    if (valorCombo != null) {
        ...
        try {
            ...
            if (validaCampos()) {
                ...
                tab.setMovimentoDiarioModel(registroMovimento("Alterar Tipo Acrescimo", valorCombo, tab.getDescricao(), null, "Alterado"));
                tipoAcrescimoBO.alterar(tab);
    ...
    private javax.swing.JComboBox comboTipoAcrescimo;
