 ...
 * @author PEMPEC
 */
public class CadastroTituloPagarBaixaFPCheque extends FinanceInternalFrame implements IRepopuladorNew {
    ...
    public CadastroTituloPagarBaixaFPCheque(CadastroTituloPagarBaixa baixa, TituloPagarModel titulo, TituloPagarBaixaFormaPagamentoModel formaPagamento, String tipoPagamento) throws SystemException {
        ...
        try {
            ...
            if (titulo.getChequeVinculado() != null && titulo.getChequeVinculado().getPk() != null && !titulo.getChequeVinculado().getPk().getId().isEmpty()) {

                cheque = chequeBO.consultarPorPk(titulo.getChequeVinculado());
            ...
            jTPortador.setText(titulo.getCedente().getNome());
            ...
            if (cheque != null && cheque.getPk() != null && !cheque.getPk().getId().isEmpty()) {

                jFTValorCheque.setText("0,00");


                if (cheque.getContaBancaria() != null) {

                    for (int i = 1; i < comboContaBancaria.getItemCount(); i++) {
                        if (cheque.getContaBancaria().getPk().getId().equalsIgnoreCase(((ContaBancariaModel) comboContaBancaria.getItemAt(i)).getPk().getId())) {
                            comboContaBancaria.setSelectedIndex(i);
                            break;
                        }
                    }
                ...
                if (cheque != null) {
                    ...
                    for (int i = 0; i < comboCheque.getItemCount(); i++) {
                        if (cheque.getPk().getId().equalsIgnoreCase(((ContaBancariaChequeModel) comboCheque.getItemAt(i)).getPk().getId())) {
                            comboCheque.setSelectedIndex(i);
                            break;
                        }
                    }
                ...
                jFTDataEmissao.setDate(cheque.getDataEmissao());

                jFTDataPrevisaoCompensacao.setDate(PempecUtil.addDayDate(cheque.getDataEmissao(), 2));

                jTPortador.setText(cheque.getPortador().toString().toUpperCase());



                jFTValorCheque.setText(PempecParse.doubleToZero(cheque.getValor()));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTPortador, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE)
                    .addComponent(jTObservacao, javax.swing.GroupLayout.DEFAULT_SIZE, 546, Short.MAX_VALUE))
                .addGap(37, 37, 37))
        );
            ...
            if (validaCampos()) {
                ...
                try {
                    ...
                    if (valorSaldo < jFTValorCheque.getValue()) {
                        ...
                        if (Controller.verificaParametroAtivo(Parametro.CBPSFPC001.getCodigo())) {
                            exibeMensagemAviso(Controller.sendMessageParametro(Parametro.CBPSFPC001.getCodigo()), null);
                            return;
                        }

                        if (Controller.verificaParametroAtivo(Parametro.CBPSFPC002.getCodigo())) {
                            if (valorSaldo < Controller.findByCodigo(Parametro.CBPSFPC002.getCodigo()).getValor().doubleValue()) {
                                exibeMensagemAviso(Controller.sendMessageParametro(Parametro.CBPSFPC002.getCodigo()), null);
                                return;
                            }
                        }
                ...
                if (validarCombos("tipoOperacao")) {
                    ...
                    tituloPagarCheque.getTipoOperacaoBancaria().setPk(new PKModel());
                    tituloPagarCheque.getTipoOperacaoBancaria().getPk().setId(((TipoOperacaoBancariaModel) comboTipoOperacaoBancaria.getSelectedItem()).getPk().getId());
...
private void comboContaBancariaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboContaBancariaItemStateChanged
    ...
    if (validarCombos("contaBancaria")) {
        ...
        try {
            ...
            Collection<ContaBancariaChequeModel> lContaBancariaCheque = chequeBO.obterPorContaBancariaStatus((ContaBancariaModel) comboContaBancaria.getSelectedItem(), collStatus);
