...
import br.com.pempec.finance.utils.tables.ColumnModelListagemTitulosReceber;
import br.com.pempec.finance.utils.tables.TableModelListagemTituloReceber;
 ...
 * @author PEMPEC
 */
public class ListagemTitulosReceber extends FinanceInternalFrame implements IRepopulador {
    ...
    public void repopularCombos() {
        ...
        tableTitulos.setModel(new TableModelListagemTituloReceber((ArrayList<TituloReceberModel>) lTitulosPeriodo));
        FontMetrics fm = tableTitulos.getFontMetrics(tableTitulos.getFont());
        tableTitulos.setColumnModel(new ColumnModelListagemTitulosReceber(fm));
        tableTitulos.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        tableTitulos.getTableHeader().setReorderingAllowed(false);

    }

    public ListagemTitulosReceber(Collection<TituloReceberModel> collTitulos, SacadoModel sacadoModel) throws SystemException {
        ...
        for (TituloReceberModel tituloReceberModel : collTitulos) {
            totalReceber += tituloReceberModel.getValorNominal();
        }

        jFTValorTotal.setText(PempecParse.doubleToZero(totalReceber));
    ...
    private void initComponents() {
        ...
        setResizable(true);
        setTitle("PEMPEC ENTERPRISE - Finance - Receber Lote");
        ...
        labelValorPagar1.setText("Total a Receber:");
            ...
            .addGroup(abaTitulosLayout.createSequentialGroup()
                ...
                .addGroup(abaTitulosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(abaTitulosLayout.createSequentialGroup()
                        ...
                        .addGap(32, 32, 32)
                        .addComponent(labelValorPagar1, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(108, 108, 108)
                        .addComponent(labelValorPagar2, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(abaTitulosLayout.createSequentialGroup()
                .addGroup(abaTitulosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(abaTitulosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(labelValorPagar2, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jFTQtd, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(labelValorPagar1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jTabbedPane1.addTab("Baixar Títulos Recebidos", abaTitulos);
    ...
    private void botaoBaixarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoBaixarActionPerformed
        ...
        if (validaCampos()) {
            ...
            for (TituloReceberModel tituloReceberModel : lTitulosPeriodo) {
                if (tituloReceberModel.getCheck()) {
                    coll.add(tituloReceberModel);
                }
            }
            ...
            try {
                ...
                new MovimentoDiarioBO().inserir(this.registroMovimento("Listagem", "0", Controller.getUsuarioLogado().getNome() + " solicitou listagem de titulos a receber  ", null, "Listado"));
