 ...
 * @author PEMPEC
 */
public class FilterReportContaBancariaCredito implements Serializable {
    ...
    public String getTituloReceber() {
        return tituloReceber;
    }

    public void setTituloReceber(String tituloReceber) {
