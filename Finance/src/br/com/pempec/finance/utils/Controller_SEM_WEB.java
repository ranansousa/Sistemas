 ...
 * @author PEMPEC
 */
public final class Controller_SEM_WEB {
    ...
    public static void setQtdMovimentosHoje(Integer qtdMovimentosHoje) {
        Controller_SEM_WEB.qtdMovimentosHoje = qtdMovimentosHoje;
    }

    public static String getMsgCamposObrigatorios() {

        return "Todos os campos da tela básica são obrigatórios.";
    }
    ...
    public static String getSerialOrganizacao() {
        String serial = Controller_SEM_WEB.getOrganizacao().getRazaoSocial();
        String delimitador = "#";

        String razao = Controller_SEM_WEB.getOrganizacao().getRazaoSocial();
        String fantasia = Controller_SEM_WEB.getOrganizacao().getFantasia();
        String codinome = Controller_SEM_WEB.getOrganizacao().getCodinome();
        String licenca = Controller_SEM_WEB.getOrganizacao().getLicenca();
        String versao = Controller_SEM_WEB.getOrganizacao().getVersao();
        String host = Controller_SEM_WEB.getOrganizacao().getHost_name();
        String ip = Controller_SEM_WEB.getOrganizacao().getHost_ip();
        String cnpj = Controller_SEM_WEB.getOrganizacao().getCnpj();

        String logradouro = Controller_SEM_WEB.getOrganizacao().getLogradouro();
        String end = Controller_SEM_WEB.getOrganizacao().getEndereco();
        String bairro = Controller_SEM_WEB.getOrganizacao().getBairro().getDescricao();
        String num = Controller_SEM_WEB.getOrganizacao().getNumero();
        String cep = Controller_SEM_WEB.getOrganizacao().getCep();
        String cidade = Controller_SEM_WEB.getOrganizacao().getCidade().getDescricao();
        String estado = Controller_SEM_WEB.getOrganizacao().getEstado().getSigla();
        String user = Controller_SEM_WEB.getUsuarioLogado().getNome();
        ...
        serial = serial + "17" + PempecParse.dateToString(Controller_SEM_WEB.getDataServidorBD());
    ...
    public static boolean getVersao() {
        ...
        versaoSistemaBD = Integer.parseInt(PempecUtil.somenteNumero(Controller_SEM_WEB.getOrganizacao().getVersao()));
    ...
    public static String sendMessageParametro(String codigo) {
        ...
        if (parametro == null) {
            return "Operação não permitida! Contactar administrador -> Mensagem de parametrização não definida.\n"
                    + "Configuração Gerais (Parametrização do Sistema).";
        }
        ...
        if (mensagem.contains(Constantes.PARAMETRIZACAO_COLUNA_STATUS)) {
            ...
            do {
                ...
                builder.append(parametro.isAtivo() ? "SIM" : "NÃO");
    ...
    public static void setCollFeriados(List<FeriadoModel> collFeriados) {
        Controller_SEM_WEB.collFeriados = collFeriados;
    }
    ...
    public static void setCollParametros(List<ParametrosModel> collParametros) {
        Controller_SEM_WEB.collParametros = collParametros;
    }
    ...
    public static void setCollGrupoAction(Collection<GrupoActionModel> collGrupoAction) {
        Controller_SEM_WEB.collGrupoAction = collGrupoAction;
    }
    ...
    public static void setCollGrupoUsuario(Collection<GrupoUsuarioModel> collGrupoUsuario) {
        Controller_SEM_WEB.collGrupoUsuario = collGrupoUsuario;
    }
    ...
    public static void setCollUsuarioAction(Collection<UsuarioActionModel> collUsuarioAction) {
        Controller_SEM_WEB.collUsuarioAction = collUsuarioAction;
    }
    ...
    public static void setServidorEmail(ServidorEmailModel servidorEmail) {
        Controller_SEM_WEB.servidorEmail = servidorEmail;
    }
    ...
    /**
     * Método que verifica se o usuario possui permissão a tela para determinada
     * action.
     *
    ...
    /**
     * Método que verifica se o grupo tem acesso a tela para determinada ação
     *
     * @param usuario Usuario
     * @param action Acão
     * @param tela Tela
    ...
    /**
     * Método utilizado para enviar e-mail. Para enviar para mais de um
     * destinatário, deve-se concatenar com ponto-e-virgula (;)
     *
     * @param remetente Quem irá enviar o e-mail
     * @param destinatario Vetor de destinatários
    ...
    public static String sendMail(String[] destinatarios, String assunto, String mensagem, File anexo, MovimentoDiarioModel mov) throws SystemException, ApplicationException {
        ...
        if (destinatarios == null || destinatarios[0] == null) {
            throw new ApplicationException("Obrigatório preenchimento do destinatário!");
        }
        ...
        try {
            ...
            message.setSentDate(Controller_SEM_WEB.getDataServidorBD());
...
//                mp.addBodyPart(mbp2);
    ...
    /**
     * Método utilizado para enviar e-mail ERRO.
     *
     * @param anexo Arquivo a ser enviado.
     * @return Mensagem de sucesso ou erro ao enviar o e-mail.
     * @throws br.com.pempec.finance.exceptions.SystemException
...
//                message.setContent(mp);
    ...
    public static void sendMailInterno(String origem, String mensagem, MovimentoDiarioModel movimentoDiarioModel) throws SystemException, ApplicationException {
        ...
        try {
            ...
            message.setSubject(" FINANCE " + origem.toUpperCase() + "  " + Controller_SEM_WEB.getOrganizacao().getSigla());
    ...
    public static boolean getConfigProperties() {
        ...
        File file = new File("C:\\finance\\config\\config.properties");
    ...
    public static Object sendToServer(Object object) {
        ...
        String urlServer = ResourcePropertiesLocator.getMessage("urlServer");
        ...
        try {
            ...
            connection.setRequestProperty("Content-Type", "java-internal/" + Controller_SEM_WEB.class.getName());
            ...
            Object retorno = input.readObject();
    ...
    public static void checarLicenca() {
        ...
        if (!getDataServidorBD().before(getOrganizacao().getDataAtualizacao())) {
            ...
            getOrganizacao().setDataAtualizacao(PempecUtil.addDayDate(dataServidorBD, 412));
