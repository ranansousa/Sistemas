 ...
 * @author PEMPEC
 */
public class ColumnModelListagemTitulosPagar extends DefaultTableColumnModel {

    public ColumnModelListagemTitulosPagar(FontMetrics fm) {
    ...
    private TableColumn criaColunaOculta(int columnIndex, int largura, FontMetrics fm, boolean resizable, String titulo) {
        ...
        col.setCellRenderer(new CellRendererListagemTitulosPagar());
