 ...
 * @author PEMPEC
 */
public class ColumnModelCadastroTituloReceberBaixaFP extends DefaultTableColumnModel {

    public ColumnModelCadastroTituloReceberBaixaFP(FontMetrics fm) {

        addColumn(criaPrimeiraColuna(0, 80, fm, false, "Opções"));
        addColumn(criaColuna(1, 370, fm, false, "Forma Pagamento"));
