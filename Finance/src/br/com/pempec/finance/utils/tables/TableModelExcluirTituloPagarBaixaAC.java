 ...
 * @author PEMPEC
 */
public class TableModelExcluirTituloPagarBaixaAC extends AbstractTableModel {

    private ArrayList<TituloPagarBaixaAcrescimoModel> collection;

    public TableModelExcluirTituloPagarBaixaAC(ArrayList<TituloPagarBaixaAcrescimoModel> collection) {
