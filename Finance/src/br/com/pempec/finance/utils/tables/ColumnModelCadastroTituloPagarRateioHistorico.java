 ...
 * @author PEMPEC
 */
public class ColumnModelCadastroTituloPagarRateioHistorico extends DefaultTableColumnModel {

    public ColumnModelCadastroTituloPagarRateioHistorico(FontMetrics fm) {
    ...
    private TableColumn criaColunaOculta(int columnIndex, int largura, FontMetrics fm, boolean resizable, String titulo) {
        ...
        col.setCellRenderer(new CellRendererCadastroTituloPagarRateioHistorico());
