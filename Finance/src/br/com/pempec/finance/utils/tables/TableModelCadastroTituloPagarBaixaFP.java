 ...
 * @author Adm
 */
public class TableModelCadastroTituloPagarBaixaFP extends AbstractTableModel {

    private ArrayList<TituloPagarBaixaFormaPagamentoModel> collection;

    public TableModelCadastroTituloPagarBaixaFP(ArrayList<TituloPagarBaixaFormaPagamentoModel> collection) {
    ...
    public void removeByID(String id) {
        ...
        for (TituloPagarBaixaFormaPagamentoModel baixaFormaPagamentoModel : collection) {
