 ...
 * @author PEMPEC
 */
public class ColumnModelCadastroTituloPagarBaixaFP extends DefaultTableColumnModel {

    public ColumnModelCadastroTituloPagarBaixaFP(FontMetrics fm) {
    ...
    private TableColumn criaColunaOculta(int columnIndex, int largura, FontMetrics fm, boolean resizable, String titulo) {
        ...
        col.setCellRenderer(new CellRendererCadastroTituloPagarBaixaFP());
