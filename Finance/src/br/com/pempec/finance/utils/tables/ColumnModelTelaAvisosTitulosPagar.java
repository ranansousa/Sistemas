 ...
 * @author PEMPEC
 */
public class ColumnModelTelaAvisosTitulosPagar extends DefaultTableColumnModel {

    public ColumnModelTelaAvisosTitulosPagar(FontMetrics fm) {
    ...
    private TableColumn criaColunaLink(int columnIndex, int largura, FontMetrics fm, boolean resizable, String titulo) {
        ...
        col.setCellEditor(new CellEditorTelaAvisosPagarTitulos());
        col.setCellRenderer(new CellRendererTelaAvisosPagarTitulos());
