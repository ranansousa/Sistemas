 ...
 * @author Adm
 */
public class TableModelCadastroTituloPagarRateioCC extends AbstractTableModel {

    private ArrayList<TituloPagarRateioCCModel> collection;

    public TableModelCadastroTituloPagarRateioCC(ArrayList<TituloPagarRateioCCModel> collection) {
        this.collection = collection;
    }

    public Object getValueAt(int rowIndex, int columnIndex) {

        TituloPagarRateioCCModel com = collection.get(rowIndex);
    ...
    public TituloPagarRateioCCModel getValues(int rowIndex) {
    ...
    public void setValueAt(Object value, int row, int col) {
        ...
        TituloPagarRateioCCModel com = collection.get(row);
    ...
    public void removeByCentroCusto(CentroCustoModel object) {
        ...
        for (TituloPagarRateioCCModel tituloPagarRateioCCModel : collection) {

            if (tituloPagarRateioCCModel.getCentroCustoModel().getPk().getId().equals(object.getPk().getId())) {
                collection.remove(tituloPagarRateioCCModel);
            }
