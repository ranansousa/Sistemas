 ...
 * @author PEMPEC
 */
public class TableModelCadastroTituloPagarBaixaAC extends AbstractTableModel {

    private ArrayList<TituloPagarBaixaAcrescimoModel> collection;

    public TableModelCadastroTituloPagarBaixaAC(ArrayList<TituloPagarBaixaAcrescimoModel> collection) {
        this.collection = collection;
    }

    public Object getValueAt(int rowIndex, int columnIndex) {

        TituloPagarBaixaAcrescimoModel com = collection.get(rowIndex);
    ...
    public TituloPagarBaixaAcrescimoModel getValues(int rowIndex) {
    ...
    public void setValueAt(Object value, int row, int col) {
        ...
        TituloPagarBaixaAcrescimoModel com = collection.get(row);
    ...
    public void removeByID(String id) {
        ...
        for (TituloPagarBaixaAcrescimoModel baixaAcrescimoModel : collection) {
