 ...
 * @author PEMPEC
 */
public class ColumnModelCadastroTituloReceberRateioHistorico extends DefaultTableColumnModel {

    public ColumnModelCadastroTituloReceberRateioHistorico(FontMetrics fm) {
    ...
    private TableColumn criaColunaOculta(int columnIndex, int largura, FontMetrics fm, boolean resizable, String titulo) {
        ...
        col.setCellRenderer(new CellRendererCadastroTituloReceberRateioHistorico());
