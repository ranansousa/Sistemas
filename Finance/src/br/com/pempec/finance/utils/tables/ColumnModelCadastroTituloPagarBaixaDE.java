 ...
 * @author PEMPEC
 */
public class ColumnModelCadastroTituloPagarBaixaDE extends DefaultTableColumnModel {

    public ColumnModelCadastroTituloPagarBaixaDE(FontMetrics fm) {
...
//        addColumn(criaColunaOculta(4, 0, fm, false, "")); // Guarda o ID da Tabela Forma_pagamento
    ...
    private TableColumn criaColunaOculta(int columnIndex, int largura, FontMetrics fm, boolean resizable, String titulo) {
        ...
        col.setCellRenderer(new CellRendererCadastroTituloPagarBaixaDE());
