 ...
 * @author PEMPEC
 */
public class TableModelExcluirTituloReceberBaixaDE extends AbstractTableModel {

    private ArrayList<TituloReceberBaixaDeducaoModel> collection;

    public TableModelExcluirTituloReceberBaixaDE(ArrayList<TituloReceberBaixaDeducaoModel> collection) {
